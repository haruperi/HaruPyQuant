...
class RandomStrategy(BaseStrategy):
    """
    This class is a template for all strategies.
    As a working example, it is used to generate random signals for the strategy.
    """
    ...
    def get_features(self, data: pd.DataFrame) -> pd.DataFrame:  
        """
        Generates random signals for the strategy.
